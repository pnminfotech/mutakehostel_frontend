...
const ProjectDashboard = (projectId) => {
  ...
  useEffect(() => {
    axios
      .get(`   https://mutakegirlshostel-0ko7.onrender.com/api/projects/${id}`)
      .then((res) => setProject(res.data))
      .catch((err) => console.log(err));
  }, [id]);
  useEffect(() => {
    axios
      .get(`h   https://mutakegirlshostel-0ko7.onrender.com/api/suppliers`)
      .then((res) => {
  ...
  const handlePaymentSubmit = async () => {
    ...
    try {
      ...
      if (selectedType === "employee") {
        ...
        apiUrl = `h   https://mutakegirlshostel-0ko7.onrender.com/api/projectEmpayment/${project._id}/employees/${selectedItem._id}/payments`;
        ...
        apiUrl = `h   https://mutakegirlshostel-0ko7.onrender.com/api/projectSpayment/${project._id}/suppliers/${selectedItem.supplierId}/materials/${selectedMaterial.materialId}/payments`;
      }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        `h   https://mutakegirlshostel-0ko7.onrender.com/api/suppliers/projects/${id}/suppliers`,
        supplierData
      );
  ...
  const handleSubmitSupplier = async (e) => {
    ...
    try {
      const response = await axios.post(
        `   https://mutakegirlshostel-0ko7.onrender.com/api/projects/add-supplier/${projectId}`,
        suppliers
      );
  ...
  const addEmployee = (e) => {
    ...
    axios
      .post(
        `   https://mutakegirlshostel-0ko7.onrender.com/api/projects/${id}/employees`,
        newEmployee
      )
      .then((res) => {
        setProject(res.data);
  ...
  const addMaterialPayment = async () => {
    ...
    const response = await fetch(
      `h   https://mutakegirlshostel-0ko7.onrender.com/api/projects/${projectId}/suppliers/${supplierId}`,
      {
        method: "POST",
        headers: {
  ...
  const updatePayment = async (type, payment, updatedData) => {
    try {
      const endpoint =
        type === "employee"
          ? `h   https://mutakegirlshostel-0ko7.onrender.com/api/project/${payment.projectId}/employee/${payment.employeeId}/payment/${payment._id}`
          : `h   https://mutakegirlshostel-0ko7.onrender.com/api/project/${payment.projectId}/supplier/${payment.supplierId}/material/${payment.materialId}/payment/${payment._id}`;
