...
const Suppliers = () => {
  ...
  const fetchSuppliers = async () => {
    try {
      const res = await axios.get("   https://mutakegirlshostel-0ko7.onrender.com/api/suppliers");
  ...
  useEffect(() => {
    fetch("   https://mutakegirlshostel-0ko7.onrender.com/api/suppliers")
      .then((res) => res.json())
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post("   https://mutakegirlshostel-0ko7.onrender.com/api/suppliers", newSupplier);
  ...
  const handleTransactionSubmit = async (e) => {
    ...
    try {
      const res = await axios.post(`   https://mutakegirlshostel-0ko7.onrender.com/api/suppliers/${selectedSupplier._id}/payment`, transaction);
