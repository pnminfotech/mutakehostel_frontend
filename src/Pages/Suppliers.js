...
const Suppliers = () => {
  ...
  const fetchSuppliers = async () => {
    try {
      const res = await axios.get("https://mutakehostel-backend.onrender.com/api/suppliers");
  ...
  useEffect(() => {
    fetch("https://mutakehostel-backend.onrender.com/api/suppliers")
      .then((res) => res.json())
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post("https://mutakehostel-backend.onrender.com/api/suppliers", newSupplier);
  ...
  const handleTransactionSubmit = async (e) => {
    ...
    try {
      const res = await axios.post(`https://mutakehostel-backend.onrender.com/api/suppliers/${selectedSupplier._id}/payment`, transaction);
