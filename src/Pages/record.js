...
const Record = () => {
  ...
  useEffect(() => {
    axios.get("https://mutakehostel-backend.onrender.com/api/suppliers")
  ...
  const handleTransactionSubmit = (e) => {
    ...
    axios.put(`https://mutakehostel-backend.onrender.com/api/suppliers/${selectedSupplier._id}/payments`, transaction)
      .then((res) => {
