...
const Record = () => {
  ...
  useEffect(() => {
    axios.get("   https://mutakegirlshostel-0ko7.onrender.com/api/suppliers")
  ...
  const handleTransactionSubmit = (e) => {
    ...
    axios.put(`   https://mutakegirlshostel-0ko7.onrender.com/api/suppliers/${selectedSupplier._id}/payments`, transaction)
      .then((res) => {
