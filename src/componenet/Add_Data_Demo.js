...
function Add_Data_Demo() {
 ...
 const [selectedYear, setSelectedYear] = useState(new Date().getFullYear()); // Default: current year
  ...
  const apiUrl = '   https://mutakegirlshostel-0ko7.onrender.com/api/'; // Replace with your actual API endpoint
  ...
  useEffect(() => {
    ...
    useEffect(() => {
      ...
      const fetchData = async () => {
        try {
          const response = await fetch(`   https://mutakegirlshostel-0ko7.onrender.com/api/form/${id}`);
    ...
    const handleDownloadForm = async (data) => {
      try {
        const response = await axios.get(`   https://mutakegirlshostel-0ko7.onrender.com/api/form/${data._id}`);
  ...
  try {
    ...
    const response = await fetch(
      `   https://mutakegirlshostel-0ko7.onrender.com/api/light-bill/all-bills?month=${currentMonth}&year=${currentYear}`
    );
    const data = await response.json();
  ...
  useEffect(() => {
    ...
    idsToArchive.forEach((id) => {
      ...
      if (recordToArchive) {
        // Archive the record
        axios
          .post(`   https://mutakegirlshostel-0ko7.onrender.com/api/forms/archive`, { id })
          .then((response) => {
  ...
  useEffect(() => {
    axios
      .get('   https://mutakegirlshostel-0ko7.onrender.com/api/forms/archived')
      .then((response) => {
  ...
  useEffect(() => {
    axios
      .get("   https://mutakegirlshostel-0ko7.onrender.com/api/forms")
      .then((response) => {
        const leaveData = {};
...
//   };
  ...
  const confirmLeave = async () => {
    ...
    try {
      const response = await fetch("   https://mutakegirlshostel-0ko7.onrender.com/api/leave", {
        method: "POST",
  ...
  const handleUpdate = () => { 
    ...
    if (newRentAmount === 0) {
      // 📌 If Rent Amount is 0, Call DELETE API    https://mutakegirlshostel-0ko7.onrender.com
      axios
        .delete(`   https://mutakegirlshostel-0ko7.onrender.com/api//api/form/${currentFormId}/rent/${monthYear}`)
        .then(() => {
  ...
  axios
  .put(`   https://mutakegirlshostel-0ko7.onrender.com/api/form/${currentFormId}`, updatedRent)
  .then((response) => {
    const patched = {
      ...response.data,
  ...
  const handleDeleteConfirm = async () => {
    try {
      await axios.delete(`   https://mutakegirlshostel-0ko7.onrender.com/api/form/${currentDeleteId}`);
...
const undoArchive = (data) => {
  axios
    .post(`   https://mutakegirlshostel-0ko7.onrender.com/api/forms/restore`, { id: data._id })
    .then(() => {
  ...
  const handleFormUpdate = () => {
    ...
    axios
      .put(`   https://mutakegirlshostel-0ko7.onrender.com/api/update/${currentFormId}`, updatedFormData)
      .then((response) => {
