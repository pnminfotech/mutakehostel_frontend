...
const FormPage = () => {
  ...
  const handleLogin = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch('   https://mutakegirlshostel-0ko7.onrender.com/api/login', {
        method: 'POST',
  ...
  const handleRegister = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch('   https://mutakegirlshostel-0ko7.onrender.com/api/register', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  return (
    <div className="container-fluid">
      <div className="row">
      <div className="container-fluid d-flex justify-content-center align-items-center" style={{marginTop:'17px' }}>
  ...
  <center>
    ...
    <div className="auth-box" style={{ maxWidth: '600px', marginTop: '30px' }}>
      {isLogin ? (
        <>
          <h1
            style={{
