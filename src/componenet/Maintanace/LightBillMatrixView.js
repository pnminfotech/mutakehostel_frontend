...
const LightBillMatrixView = () => {
  ...
  const fetchAll = async () => {
    const res = await fetch("https://hostelpaymentmanger.onrender.com/api/light-bill/all");
  ...
  const handleAdd = async () => {
    ...
    const res = await fetch("https://hostelpaymentmanger.onrender.com/api/light-bill", {
      method: "POST",
