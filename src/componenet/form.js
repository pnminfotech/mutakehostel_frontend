...
const isTenant = params.get("tenant") === "true";
  ...
  const fetchSrNo = async () => {
    try {
      const response = await axios.get('  https://mutakehostel-api.pnminfotech.com/api/forms/count');
...
const handleSubmit = async (e) => {
  e.preventDefault();
  try {
    await axios.post('  https://mutakehostel-api.pnminfotech.com/api/forms', formData);
